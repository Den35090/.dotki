...
namespace DiskMonitorApp
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            // Запуск фонового потока мониторинга критического места
        ...
        static void LogAction(string message)
        {
            ...
            catch { /* Игнорируем ошибки логирования, чтобы не прерывать мониторинг */ }
        }
